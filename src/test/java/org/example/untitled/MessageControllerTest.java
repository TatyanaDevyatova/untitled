...
import org.example.untitled.controller.MessageController;
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/main")
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id='1']")
                        .exists())
                .andExpect(xpath("//div[@id='message-list']/div[@data-id='3']")
                        .exists());
    }
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id='10']")
                        .exists())
                .andExpect(xpath("//div[@id='message-list']/div[@data-id='10']/div/span")
                        .string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id='10']/div/i")
                        .string("#new one"));
    }
