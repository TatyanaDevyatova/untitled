...
//@PreAuthorize("hasAuthority('ADMIN')")
// замените на @PreAuthorize("hasAuthority('USER')").
// Теперь доступ будет разрешен.
// Зайдите на /user и назначте ADMIN одному из ваших юзеров.
// Не забудьте вернуть "hasAuthority('ADMIN')".